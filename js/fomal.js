...
$.ajax({
  ...
  data: {
    key: 'UA6BZ-ZG2KW-XZTR3-RGLQK-A5JU2-HWF66',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Elysianya🥝 %c 你正在访问Elysianya🥝の小家",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/img/bg1.jpg);
    --darkmode-bg: url(https://source.fomal.cc/img/dm2.webp);
